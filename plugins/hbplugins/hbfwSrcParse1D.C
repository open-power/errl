                         ...
                         const SrciSrc & i_src)
{
    ...
    case 0x1D3658:
        ...
        i_parser.PrintString("moduleid", "VPD::VPD_DVPD_PRESENCEDETECT");
    ...
    case 0x1D3b80:
        i_parser.PrintString("devdesc", "Node for VPD is too large");
        i_parser.PrintString("moduleid", "VPD::VPD_RT_GET_ADDR");
        i_parser.PrintString("reasoncode", "VPD::VPD_RT_NODE_TOO_LARGE");
        i_parser.PrintString("userdata1", "Node ID");
        i_parser.PrintString("userdata2", "Rsvd Mem Address array size");
        break;
    ...
    case 0x1D1a80:
        ...
        i_parser.PrintString("userdata2", "Node ID");
        break;
    ...
    case 0x1D3783:
        ...
        i_parser.PrintString("moduleid", "VPD_SEND_MBOX_WRITE_MESSAGE");
        i_parser.PrintString("reasoncode", "VPD_RT_NULL_FIRMWARE_REQUEST_PTR");
        i_parser.PrintString("userdata1", "HUID of target");
        i_parser.PrintString("userdata2", "VPD message type");
        break;
