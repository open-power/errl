                         ...
                         const SrciSrc & i_src)
{
    ...
    case 0x261C09:
        i_parser.PrintString("devdesc", "Invalid pass thru command data len");
    ...
    case 0x264509:
        i_parser.PrintString("devdesc", "Invalid load pstate table type");
        i_parser.PrintString("moduleid", "HTMGT_MOD_PASS_THRU");
        i_parser.PrintString("reasoncode", "HTMGT_RC_INVALID_PARAMETER");
        i_parser.PrintString("userdata1", "command data[0-7]");
        i_parser.PrintString("userdata2", "command data length");
    ...
    case 0x261608:
        i_parser.PrintString("devdesc", "Homer pointer is NULL, unable to communicate with the OCCs.  Leaving system in safe mode.");
    ...
    case 0x265607:
        ...
        i_parser.PrintString("reasoncode", "HTMGT_RC_OCC_RESET_THREHOLD");
    ...
    case 0x260E90:
        i_parser.PrintString("devdesc", "Unable to send cmd to OCC due to exception");
    ...
    case 0x26450A:
        i_parser.PrintString("devdesc", "Invalid ATTR_FREQ_EXT_BIAS attribute values");
        i_parser.PrintString("moduleid", "HTMGT_MOD_CFG_FREQ_POINTS");
        i_parser.PrintString("reasoncode", "HTMGT_RC_INVALID_PARAMETER");
        i_parser.PrintString("userdata1", "ATTR_FREQ_EXT_BIAS_UP");
        i_parser.PrintString("userdata2", "ATTR_FREQ_EXT_BIAS_DOWN");
        break;

    case 0x26060A:
        i_parser.PrintString("devdesc", "Unable to read FREQ_EXT_BIAS attributes");
        i_parser.PrintString("moduleid", "HTMGT_MOD_CFG_FREQ_POINTS");
        i_parser.PrintString("reasoncode", "HTMGT_RC_ATTRIBUTE_ERROR");
        i_parser.PrintString("userdata1[0-31]", "rc");
        i_parser.PrintString("userdata1[32-63]", "ATTR_FREQ_EXT_BIAS_UP");
        i_parser.PrintString("userdata2", "ATTR_FREQ_EXT_BIAS_DOWN");
        break;

    case 0x260403:
        i_parser.PrintString("devdesc", "Overtemp Throttle HW procedure calculated an invalid numerator value.");
        i_parser.PrintString("moduleid", "HTMGT_MOD_MEMTHROTTLE");
        i_parser.PrintString("reasoncode", "HTMGT_RC_OT_THROTTLE_INVALID_N");
        i_parser.PrintString("userdata1", "MBA HUID");
        break;

    case 0x260303:
        i_parser.PrintString("devdesc", "Throttle HW procedure calculated an invalid numerator value.");
        i_parser.PrintString("moduleid", "HTMGT_MOD_MEMTHROTTLE");
        i_parser.PrintString("reasoncode", "HTMGT_RC_THROTTLE_INVALID_N");
        i_parser.PrintString("userdata1", "MBA HUID");
        i_parser.PrintString("userdata2[0:31]", "MBA numerator");
        i_parser.PrintString("userdata2[32:63]", "Chip numerator");
        break;

    case 0x260203:
        i_parser.PrintString("devdesc", "Throttle numerator calculated doesn't meet min utilization");
        i_parser.PrintString("moduleid", "HTMGT_MOD_MEMTHROTTLE");
        i_parser.PrintString("reasoncode", "HTMGT_RC_THROTTLE_UTIL_ERROR");
        i_parser.PrintString("userdata1", "MBA HUID");
        i_parser.PrintString("userdata2[0:31]", "util based N");
        i_parser.PrintString("userdata2[32:63]", "calculated N");
        break;
