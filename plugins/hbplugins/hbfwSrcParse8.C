                         ...
                         const SrciSrc & i_src)
{
    ...
    case 0x80806:
        i_parser.PrintString("devdesc", "Secureboot page verify failure.");
        i_parser.PrintString("moduleid", "VFS_VERIFY_PAGE");
        i_parser.PrintString("reasoncode", "VFS_PAGE_VERIFY_FAILED");
        i_parser.PrintString("userdata1", "Kernel RC");
        i_parser.PrintString("userdata2", "virtual address accessed");
        break;
