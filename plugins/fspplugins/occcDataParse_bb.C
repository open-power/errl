...
//  
// fips920 src/occc/fsp/plugins/occcDataParse.C 1.24 
//  
// IBM CONFIDENTIAL 
//  
...
/*****************************************************************************/
static void PrintSensorData(const char * i_name, const ChomSensor_t i_sensor)
{
...
/*****************************************************************************/
static void PrintFClipHistory( const char * i_name,
...
/*****************************************************************************/
static void PrintErrorHistory( const char * i_name,
...
/*****************************************************************************/
static void PrintCallHomeAPSSSensor( const char * i_name,
...
/*****************************************************************************/
static void PrintCallHomeSensorData(const char * i_name, const uint16_t i_sample, const uint16_t i_average,
...
// Do sanity check on the function inputs
    if (sizeof(ChomLogData_v0_t) == i_len)
    {
        do
        {
            i_parser.PrintNumber("Number of Sensors",
                                "%d",
                                ntohs(i_chom->nodeData.numSensors));
            ...
            // Node total power (DC)
            PrintCallHomeSensorData("CHOMPWR", ntohs(i_chom->sensorData[i].sensor[VER_0::CHOMPWR].sample),
            ...
            PrintSensorData("CHOMPWRS0", i_chom->sensorData[i].sensor[VER_0::CHOMPWRS0]);
            PrintSensorData("CHOMPWRS1", i_chom->sensorData[i].sensor[VER_0::CHOMPWRS1]);
            PrintSensorData("CHOMPWRS2", i_chom->sensorData[i].sensor[VER_0::CHOMPWRS2]);
            PrintSensorData("CHOMPWRS3", i_chom->sensorData[i].sensor[VER_0::CHOMPWRS3]);
            PrintSensorData("CHOMPWRS4", i_chom->sensorData[i].sensor[VER_0::CHOMPWRS4]);
            PrintSensorData("CHOMPWRS5", i_chom->sensorData[i].sensor[VER_0::CHOMPWRS5]);
            PrintSensorData("CHOMPWRS6", i_chom->sensorData[i].sensor[VER_0::CHOMPWRS6]);
            PrintSensorData("CHOMPWRS7", i_chom->sensorData[i].sensor[VER_0::CHOMPWRS7]);
            i_parser.PrintDivider();
            // Memory power
            i_parser.PrintString("Memory Power", "");
            PrintSensorData("CHOMPWRM0", i_chom->sensorData[i].sensor[VER_0::CHOMPWRM0]);
            PrintSensorData("CHOMPWRM1", i_chom->sensorData[i].sensor[VER_0::CHOMPWRM1]);
            PrintSensorData("CHOMPWRM2", i_chom->sensorData[i].sensor[VER_0::CHOMPWRM2]);
            PrintSensorData("CHOMPWRM3", i_chom->sensorData[i].sensor[VER_0::CHOMPWRM3]);
            PrintSensorData("CHOMPWRM4", i_chom->sensorData[i].sensor[VER_0::CHOMPWRM4]);
            PrintSensorData("CHOMPWRM5", i_chom->sensorData[i].sensor[VER_0::CHOMPWRM5]);
            PrintSensorData("CHOMPWRM6", i_chom->sensorData[i].sensor[VER_0::CHOMPWRM6]);
            PrintSensorData("CHOMPWRM7", i_chom->sensorData[i].sensor[VER_0::CHOMPWRM7]);
            // Fan power
            PrintCallHomeSensorData("CHOMPWRFAN", ntohs(i_chom->sensorData[i].sensor[VER_0::CHOMPWRFAN].sample),
            ...
            PrintSensorData("CHOMFREQP0",i_chom->sensorData[i].sensor[VER_0::CHOMFREQP0]);
            PrintSensorData("CHOMFREQP1",i_chom->sensorData[i].sensor[VER_0::CHOMFREQP1]);
            PrintSensorData("CHOMFREQP2",i_chom->sensorData[i].sensor[VER_0::CHOMFREQP2]);
            PrintSensorData("CHOMFREQP3",i_chom->sensorData[i].sensor[VER_0::CHOMFREQP3]);
            PrintSensorData("CHOMFREQP4",i_chom->sensorData[i].sensor[VER_0::CHOMFREQP4]);
            PrintSensorData("CHOMFREQP5",i_chom->sensorData[i].sensor[VER_0::CHOMFREQP5]);
            PrintSensorData("CHOMFREQP6",i_chom->sensorData[i].sensor[VER_0::CHOMFREQP6]);
            PrintSensorData("CHOMFREQP7",i_chom->sensorData[i].sensor[VER_0::CHOMFREQP7]);

            i_parser.PrintDivider();
            // Processor utilization sensor
            i_parser.PrintString("Processor utilization", "");
            PrintSensorData("CHOMUTILP0", i_chom->sensorData[i].sensor[VER_0::CHOMUTILP0]);
            PrintSensorData("CHOMUTILP1", i_chom->sensorData[i].sensor[VER_0::CHOMUTILP1]);
            PrintSensorData("CHOMUTILP2", i_chom->sensorData[i].sensor[VER_0::CHOMUTILP2]);
            PrintSensorData("CHOMUTILP3", i_chom->sensorData[i].sensor[VER_0::CHOMUTILP3]);
            PrintSensorData("CHOMUTILP4", i_chom->sensorData[i].sensor[VER_0::CHOMUTILP4]);
            PrintSensorData("CHOMUTILP5", i_chom->sensorData[i].sensor[VER_0::CHOMUTILP5]);
            PrintSensorData("CHOMUTILP6", i_chom->sensorData[i].sensor[VER_0::CHOMUTILP6]);
            PrintSensorData("CHOMUTILP7", i_chom->sensorData[i].sensor[VER_0::CHOMUTILP7]);
            // Max core temperature for all processors in the node
            PrintCallHomeSensorData("CHOMTEMPPROC", ntohs(i_chom->sensorData[i].sensor[VER_0::CHOMTEMPPROC].sample),
            ...
            PrintCallHomeSensorData("CHOMTEMPCENT", ntohs(i_chom->sensorData[i].sensor[VER_0::CHOMTEMPCENT].sample),
            ...
            PrintCallHomeSensorData("CHOMTEMPDIMM", ntohs(i_chom->sensorData[i].sensor[VER_0::CHOMTEMPDIMM].sample),
            ...
            PrintCallHomeSensorData("CHOMIPS", ntohs(i_chom->sensorData[i].sensor[VER_0::CHOMIPS].sample),
            ...
            PrintSensorData("CHOMBWP0M0", i_chom->sensorData[i].sensor[VER_0::CHOMBWP0M0]);
            PrintSensorData("CHOMBWP0M1", i_chom->sensorData[i].sensor[VER_0::CHOMBWP0M1]);
            PrintSensorData("CHOMBWP0M2", i_chom->sensorData[i].sensor[VER_0::CHOMBWP0M2]);
            PrintSensorData("CHOMBWP0M3", i_chom->sensorData[i].sensor[VER_0::CHOMBWP0M3]);
            PrintSensorData("CHOMBWP0M4", i_chom->sensorData[i].sensor[VER_0::CHOMBWP0M4]);
            PrintSensorData("CHOMBWP0M5", i_chom->sensorData[i].sensor[VER_0::CHOMBWP0M5]);
            PrintSensorData("CHOMBWP0M6", i_chom->sensorData[i].sensor[VER_0::CHOMBWP0M6]);
            PrintSensorData("CHOMBWP0M7", i_chom->sensorData[i].sensor[VER_0::CHOMBWP0M7]);
            PrintSensorData("CHOMBWP1M0", i_chom->sensorData[i].sensor[VER_0::CHOMBWP1M0]);
            PrintSensorData("CHOMBWP1M1", i_chom->sensorData[i].sensor[VER_0::CHOMBWP1M1]);
            PrintSensorData("CHOMBWP1M2", i_chom->sensorData[i].sensor[VER_0::CHOMBWP1M2]);
            PrintSensorData("CHOMBWP1M3", i_chom->sensorData[i].sensor[VER_0::CHOMBWP1M3]);
            PrintSensorData("CHOMBWP1M4", i_chom->sensorData[i].sensor[VER_0::CHOMBWP1M4]);
            PrintSensorData("CHOMBWP1M5", i_chom->sensorData[i].sensor[VER_0::CHOMBWP1M5]);
            PrintSensorData("CHOMBWP1M6", i_chom->sensorData[i].sensor[VER_0::CHOMBWP1M6]);
            PrintSensorData("CHOMBWP1M7", i_chom->sensorData[i].sensor[VER_0::CHOMBWP1M7]);
            PrintSensorData("CHOMBWP2M0", i_chom->sensorData[i].sensor[VER_0::CHOMBWP2M0]);
            PrintSensorData("CHOMBWP2M1", i_chom->sensorData[i].sensor[VER_0::CHOMBWP2M1]);
            PrintSensorData("CHOMBWP2M2", i_chom->sensorData[i].sensor[VER_0::CHOMBWP2M2]);
            PrintSensorData("CHOMBWP2M3", i_chom->sensorData[i].sensor[VER_0::CHOMBWP2M3]);
            PrintSensorData("CHOMBWP2M4", i_chom->sensorData[i].sensor[VER_0::CHOMBWP2M4]);
            PrintSensorData("CHOMBWP2M5", i_chom->sensorData[i].sensor[VER_0::CHOMBWP2M5]);
            PrintSensorData("CHOMBWP2M6", i_chom->sensorData[i].sensor[VER_0::CHOMBWP2M6]);
            PrintSensorData("CHOMBWP2M7", i_chom->sensorData[i].sensor[VER_0::CHOMBWP2M7]);
            PrintSensorData("CHOMBWP3M0", i_chom->sensorData[i].sensor[VER_0::CHOMBWP3M0]);
            PrintSensorData("CHOMBWP3M1", i_chom->sensorData[i].sensor[VER_0::CHOMBWP3M1]);
            PrintSensorData("CHOMBWP3M2", i_chom->sensorData[i].sensor[VER_0::CHOMBWP3M2]);
            PrintSensorData("CHOMBWP3M3", i_chom->sensorData[i].sensor[VER_0::CHOMBWP3M3]);
            PrintSensorData("CHOMBWP3M4", i_chom->sensorData[i].sensor[VER_0::CHOMBWP3M4]);
            PrintSensorData("CHOMBWP3M5", i_chom->sensorData[i].sensor[VER_0::CHOMBWP3M5]);
            PrintSensorData("CHOMBWP3M6", i_chom->sensorData[i].sensor[VER_0::CHOMBWP3M6]);
            PrintSensorData("CHOMBWP3M7", i_chom->sensorData[i].sensor[VER_0::CHOMBWP3M7]);
            PrintSensorData("CHOMBWP4M0", i_chom->sensorData[i].sensor[VER_0::CHOMBWP4M0]);
            PrintSensorData("CHOMBWP4M1", i_chom->sensorData[i].sensor[VER_0::CHOMBWP4M1]);
            PrintSensorData("CHOMBWP4M2", i_chom->sensorData[i].sensor[VER_0::CHOMBWP4M2]);
            PrintSensorData("CHOMBWP4M3", i_chom->sensorData[i].sensor[VER_0::CHOMBWP4M3]);
            PrintSensorData("CHOMBWP4M4", i_chom->sensorData[i].sensor[VER_0::CHOMBWP4M4]);
            PrintSensorData("CHOMBWP4M5", i_chom->sensorData[i].sensor[VER_0::CHOMBWP4M5]);
            PrintSensorData("CHOMBWP4M6", i_chom->sensorData[i].sensor[VER_0::CHOMBWP4M6]);
            PrintSensorData("CHOMBWP4M7", i_chom->sensorData[i].sensor[VER_0::CHOMBWP4M7]);
            PrintSensorData("CHOMBWP5M0", i_chom->sensorData[i].sensor[VER_0::CHOMBWP5M0]);
            PrintSensorData("CHOMBWP5M1", i_chom->sensorData[i].sensor[VER_0::CHOMBWP5M1]);
            PrintSensorData("CHOMBWP5M2", i_chom->sensorData[i].sensor[VER_0::CHOMBWP5M2]);
            PrintSensorData("CHOMBWP5M3", i_chom->sensorData[i].sensor[VER_0::CHOMBWP5M3]);
            PrintSensorData("CHOMBWP5M4", i_chom->sensorData[i].sensor[VER_0::CHOMBWP5M4]);
            PrintSensorData("CHOMBWP5M5", i_chom->sensorData[i].sensor[VER_0::CHOMBWP5M5]);
            PrintSensorData("CHOMBWP5M6", i_chom->sensorData[i].sensor[VER_0::CHOMBWP5M6]);
            PrintSensorData("CHOMBWP5M7", i_chom->sensorData[i].sensor[VER_0::CHOMBWP5M7]);
            PrintSensorData("CHOMBWP6M0", i_chom->sensorData[i].sensor[VER_0::CHOMBWP6M0]);
            PrintSensorData("CHOMBWP6M1", i_chom->sensorData[i].sensor[VER_0::CHOMBWP6M1]);
            PrintSensorData("CHOMBWP6M2", i_chom->sensorData[i].sensor[VER_0::CHOMBWP6M2]);
            PrintSensorData("CHOMBWP6M3", i_chom->sensorData[i].sensor[VER_0::CHOMBWP6M3]);
            PrintSensorData("CHOMBWP6M4", i_chom->sensorData[i].sensor[VER_0::CHOMBWP6M4]);
            PrintSensorData("CHOMBWP6M5", i_chom->sensorData[i].sensor[VER_0::CHOMBWP6M5]);
            PrintSensorData("CHOMBWP6M6", i_chom->sensorData[i].sensor[VER_0::CHOMBWP6M6]);
            PrintSensorData("CHOMBWP6M7", i_chom->sensorData[i].sensor[VER_0::CHOMBWP6M7]);
            PrintSensorData("CHOMBWP7M0", i_chom->sensorData[i].sensor[VER_0::CHOMBWP7M0]);
            PrintSensorData("CHOMBWP7M1", i_chom->sensorData[i].sensor[VER_0::CHOMBWP7M1]);
            PrintSensorData("CHOMBWP7M2", i_chom->sensorData[i].sensor[VER_0::CHOMBWP7M2]);
            PrintSensorData("CHOMBWP7M3", i_chom->sensorData[i].sensor[VER_0::CHOMBWP7M3]);
            PrintSensorData("CHOMBWP7M4", i_chom->sensorData[i].sensor[VER_0::CHOMBWP7M4]);
            PrintSensorData("CHOMBWP7M5", i_chom->sensorData[i].sensor[VER_0::CHOMBWP7M5]);
            PrintSensorData("CHOMBWP7M6", i_chom->sensorData[i].sensor[VER_0::CHOMBWP7M6]);
            PrintSensorData("CHOMBWP7M7", i_chom->sensorData[i].sensor[VER_0::CHOMBWP7M7]);
            i++;
        } while (i < i_modes);
    }
...
static void PrintCallHomeSensors( ErrlUsrParser & i_parser,
                                  const ChomNodeData_v1_t * i_node,
                                  const ChomSensorData_v1_t * i_sensor_data,
                                  uint8_t i_mode_idx)
{

    i_parser.PrintDivider();
    i_parser.PrintString("Sensor Data", i_mode_idx == 0 ? "Current Power Mode": "Previous Power Mode");
    PrintPwrMode(i_parser, "Power Saving Mode", i_sensor_data->pwrMode.mode);
    i_parser.PrintNumber("Number of Samples", "%d", ntohs(i_sensor_data->pwrMode.numOfSamples));

    // Node total power (DC)
    PrintCallHomeSensorData("CHOMPWR",
                ntohs(i_sensor_data->sensor[VER_1::CHOMPWR].sample),
                ntohs(i_sensor_data->sensor[VER_1::CHOMPWR].average),
                ntohs(i_sensor_data->sensor[VER_1::CHOMPWR].sampleMin),
                ntohs(i_sensor_data->sensor[VER_1::CHOMPWR].sampleMax));

    i_parser.PrintDivider();

    // APSS Channel information
    i_parser.PrintString("APSS Channels", "");
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH0",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH0],
                            i_node->channelFuncIds[0]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH1",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH1],
                            i_node->channelFuncIds[1]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH2",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH2],
                            i_node->channelFuncIds[2]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH3",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH3],
                            i_node->channelFuncIds[3]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH4",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH4],
                            i_node->channelFuncIds[4]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH5",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH5],
                            i_node->channelFuncIds[5]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH6",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH6],
                            i_node->channelFuncIds[6]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH7",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH7],
                            i_node->channelFuncIds[7]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH8",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH8],
                            i_node->channelFuncIds[8]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH9",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH9],
                            i_node->channelFuncIds[9]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH10",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH10],
                            i_node->channelFuncIds[10]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH11",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH11],
                            i_node->channelFuncIds[11]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH12",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH12],
                            i_node->channelFuncIds[12]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH13",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH13],
                            i_node->channelFuncIds[13]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH14",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH14],
                            i_node->channelFuncIds[14]);
    PrintCallHomeAPSSSensor("CHOMPWRAPSSCH15",
                            i_sensor_data->sensor[VER_1::CHOMPWRAPSSCH15],
                            i_node->channelFuncIds[15]);
    i_parser.PrintDivider();

    // Processor frequency
    i_parser.PrintString("Processor Frequency", "");
    PrintSensorData("CHOMFREQP0",i_sensor_data->sensor[VER_1::CHOMFREQP0]);
    PrintSensorData("CHOMFREQP1",i_sensor_data->sensor[VER_1::CHOMFREQP1]);
    PrintSensorData("CHOMFREQP2",i_sensor_data->sensor[VER_1::CHOMFREQP2]);
    PrintSensorData("CHOMFREQP3",i_sensor_data->sensor[VER_1::CHOMFREQP3]);

    i_parser.PrintDivider();

    // Processor utilization sensor
    i_parser.PrintString("Processor utilization", "");
    PrintSensorData("CHOMUTILP0", i_sensor_data->sensor[VER_1::CHOMUTILP0]);
    PrintSensorData("CHOMUTILP1", i_sensor_data->sensor[VER_1::CHOMUTILP1]);
    PrintSensorData("CHOMUTILP2", i_sensor_data->sensor[VER_1::CHOMUTILP2]);
    PrintSensorData("CHOMUTILP3", i_sensor_data->sensor[VER_1::CHOMUTILP3]);
    i_parser.PrintDivider();

    // Max core temperature for all processors in the node
    i_parser.PrintString("Processor Temperatures", "");
    PrintSensorData("CHOMTEMPPROC0",
                     i_sensor_data->sensor[VER_1::CHOMTEMPPROC0]);
    PrintSensorData("CHOMTEMPPROC1",
                     i_sensor_data->sensor[VER_1::CHOMTEMPPROC1]);
    PrintSensorData("CHOMTEMPPROC2",
                     i_sensor_data->sensor[VER_1::CHOMTEMPPROC2]);
    PrintSensorData("CHOMTEMPPROC3",
                     i_sensor_data->sensor[VER_1::CHOMTEMPPROC3]);
    i_parser.PrintDivider();

    // Centaur temperatures
    i_parser.PrintString("Centaur Temperatures", "");
    PrintSensorData("CHOMTEMPCENT0",
                     i_sensor_data->sensor[VER_1::CHOMTEMPCENTP0]);
    PrintSensorData("CHOMTEMPCENT1",
                     i_sensor_data->sensor[VER_1::CHOMTEMPCENTP1]);
    PrintSensorData("CHOMTEMPCENT2",
                     i_sensor_data->sensor[VER_1::CHOMTEMPCENTP2]);
    PrintSensorData("CHOMTEMPCENT3",
                     i_sensor_data->sensor[VER_1::CHOMTEMPCENTP3]);
    i_parser.PrintDivider();


    // DIMM temperatures
    i_parser.PrintString("DIMM Temperatures", "");
    PrintSensorData("CHOMTEMPDIMMP0",
                     i_sensor_data->sensor[VER_1::CHOMTEMPDIMMP0]);
    PrintSensorData("CHOMTEMPDIMMP1",
                     i_sensor_data->sensor[VER_1::CHOMTEMPDIMMP1]);
    PrintSensorData("CHOMTEMPDIMMP2",
                     i_sensor_data->sensor[VER_1::CHOMTEMPDIMMP2]);
    PrintSensorData("CHOMTEMPDIMMP3",
                     i_sensor_data->sensor[VER_1::CHOMTEMPDIMMP3]);
    i_parser.PrintDivider();

    //VRM VDD temperatures
    i_parser.PrintString("VRM VDD Temperatures", "");
    PrintSensorData("CHOMTEMPVDDP0",
                     i_sensor_data->sensor[VER_1::CHOMTEMPVDDP0]);
    PrintSensorData("CHOMTEMPVDDP1",
                     i_sensor_data->sensor[VER_1::CHOMTEMPVDDP1]);
    PrintSensorData("CHOMTEMPVDDP2",
                     i_sensor_data->sensor[VER_1::CHOMTEMPVDDP2]);
    PrintSensorData("CHOMTEMPVDDP3",
                     i_sensor_data->sensor[VER_1::CHOMTEMPVDDP3]);

    // Instructions per second sensor
    PrintCallHomeSensorData("CHOMIPS",
            ntohs(i_sensor_data->sensor[VER_1::CHOMIPS].sample),
            ntohs(i_sensor_data->sensor[VER_1::CHOMIPS].average),
            ntohs(i_sensor_data->sensor[VER_1::CHOMIPS].sampleMin),
            ntohs(i_sensor_data->sensor[VER_1::CHOMIPS].sampleMax));
    i_parser.PrintDivider();

    // Memory bandwidth for process memory controller
    i_parser.PrintString("Memory bandwidth", "");
    PrintSensorData("CHOMBWP0M0", i_sensor_data->sensor[VER_1::CHOMBWP0M0]);
    PrintSensorData("CHOMBWP0M1", i_sensor_data->sensor[VER_1::CHOMBWP0M1]);
    PrintSensorData("CHOMBWP0M2", i_sensor_data->sensor[VER_1::CHOMBWP0M2]);
    PrintSensorData("CHOMBWP0M3", i_sensor_data->sensor[VER_1::CHOMBWP0M3]);
    PrintSensorData("CHOMBWP0M4", i_sensor_data->sensor[VER_1::CHOMBWP0M4]);
    PrintSensorData("CHOMBWP0M5", i_sensor_data->sensor[VER_1::CHOMBWP0M5]);
    PrintSensorData("CHOMBWP0M6", i_sensor_data->sensor[VER_1::CHOMBWP0M6]);
    PrintSensorData("CHOMBWP0M7", i_sensor_data->sensor[VER_1::CHOMBWP0M7]);
    PrintSensorData("CHOMBWP1M0", i_sensor_data->sensor[VER_1::CHOMBWP1M0]);
    PrintSensorData("CHOMBWP1M1", i_sensor_data->sensor[VER_1::CHOMBWP1M1]);
    PrintSensorData("CHOMBWP1M2", i_sensor_data->sensor[VER_1::CHOMBWP1M2]);
    PrintSensorData("CHOMBWP1M3", i_sensor_data->sensor[VER_1::CHOMBWP1M3]);
    PrintSensorData("CHOMBWP1M4", i_sensor_data->sensor[VER_1::CHOMBWP1M4]);
    PrintSensorData("CHOMBWP1M5", i_sensor_data->sensor[VER_1::CHOMBWP1M5]);
    PrintSensorData("CHOMBWP1M6", i_sensor_data->sensor[VER_1::CHOMBWP1M6]);
    PrintSensorData("CHOMBWP1M7", i_sensor_data->sensor[VER_1::CHOMBWP1M7]);
    PrintSensorData("CHOMBWP2M0", i_sensor_data->sensor[VER_1::CHOMBWP2M0]);
    PrintSensorData("CHOMBWP2M1", i_sensor_data->sensor[VER_1::CHOMBWP2M1]);
    PrintSensorData("CHOMBWP2M2", i_sensor_data->sensor[VER_1::CHOMBWP2M2]);
    PrintSensorData("CHOMBWP2M3", i_sensor_data->sensor[VER_1::CHOMBWP2M3]);
    PrintSensorData("CHOMBWP2M4", i_sensor_data->sensor[VER_1::CHOMBWP2M4]);
    PrintSensorData("CHOMBWP2M5", i_sensor_data->sensor[VER_1::CHOMBWP2M5]);
    PrintSensorData("CHOMBWP2M6", i_sensor_data->sensor[VER_1::CHOMBWP2M6]);
    PrintSensorData("CHOMBWP2M7", i_sensor_data->sensor[VER_1::CHOMBWP2M7]);
    PrintSensorData("CHOMBWP3M0", i_sensor_data->sensor[VER_1::CHOMBWP3M0]);
    PrintSensorData("CHOMBWP3M1", i_sensor_data->sensor[VER_1::CHOMBWP3M1]);
    PrintSensorData("CHOMBWP3M2", i_sensor_data->sensor[VER_1::CHOMBWP3M2]);
    PrintSensorData("CHOMBWP3M3", i_sensor_data->sensor[VER_1::CHOMBWP3M3]);
    PrintSensorData("CHOMBWP3M4", i_sensor_data->sensor[VER_1::CHOMBWP3M4]);
    PrintSensorData("CHOMBWP3M5", i_sensor_data->sensor[VER_1::CHOMBWP3M5]);
    PrintSensorData("CHOMBWP3M6", i_sensor_data->sensor[VER_1::CHOMBWP3M6]);
    PrintSensorData("CHOMBWP3M7", i_sensor_data->sensor[VER_1::CHOMBWP3M7]);
                                     ...
                                     uint8_t i_modes )
{
    ...
    if (sizeof(ChomLogData_v1_t) == i_len)
    {
        do
        {
            ...
            PrintErrorHistory("Slave 1",
                               i_chom->nodeData.errhCounts[0] );
            PrintErrorHistory("Slave 2",
                               i_chom->nodeData.errhCounts[1] );
            PrintErrorHistory("Slave 3",
    ...
    if(sizeof(ChomLogData_v2_t) == i_len)
    {
        do
        {
            i_parser.PrintNumber("Number of Sensors",
                                ...
                                ntohs(i_chom->nodeData.numSensors));
            PrintCallHomeSensors( i_parser,
                                 (ChomNodeData_v1_t*)(&i_chom->nodeData),
                                 (ChomSensorData_v1_t*)(&i_chom->sensorData[i]),
                                  i );
            ...
            PrintFClipHistory("Slave 1",
                              i_chom->nodeData.fClipHist[0] );
            PrintFClipHistory("Slave 2",
                              i_chom->nodeData.fClipHist[1] );
            PrintFClipHistory("Slave 3",
